...
- [ ] Confirm the only uploaded model artifact is the audited public ETH 15m learning model documented in `docs/PUBLIC_MODEL_PACK.md`.
...
This export is intended for public GitHub code sharing only. It includes one small public ETH 15m learning model, but it is not a runnable live-trading deployment and must not be connected to real funds.
