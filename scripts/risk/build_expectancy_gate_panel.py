...
DEFAULT_OUTPUT = REPORTS_DIR / "expectancy_gate_panel.parquet"
DEFAULT_META = REPORTS_DIR / "expectancy_gate_panel_meta.json"
...
def parse_args() -> argparse.Namespace:
    ap = argparse.ArgumentParser(description="Build expectancy gate panel from long-history UP/DOWN risk panels")
...
def main() -> int:
    ...
    if panel_df.empty:
        raise RuntimeError("no expectancy rows after merging up/down source panels")
    ...
    print(f"[OK] wrote expectancy gate panel: {args.output}")
